...
/**
 * Class to print any array of Objects as a line in a formatted table
 * Each element in input array is to be printed in a different column
...
//			fp.printData(d1);
		...
		/**
		 * @param headers used to generate widths, add spaces to elements in header array if columns are not wide enough
		 * @param data 
		 * @param dp decimal places for printing doubles
		 * @param sep seperator for table, usually '|'
		 */
		...
		/**
		 * Testing advanced functionality, not in use currently
		 * @param headers
		 * @param data
		 * @param dp
		 */
